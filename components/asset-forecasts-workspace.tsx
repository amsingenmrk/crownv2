...
function forecastScenarioStorageKey(assetId: string) {
  return `glassbox:forecast-scenarios:${assetId}`
}

function forecastOutlookSetStorageKey(assetId: string) {
...
function parseStoredForecastScenarios(
  raw: string | null,
  fallback: ForecastEconomicOutlookScenario[]
): ForecastEconomicOutlookScenario[] {
...
function parseStoredForecastOutlookSets(
  raw: string | null,
  defaults: ForecastEconomicOutlookScenario[]
): ForecastOutlookSet[] {

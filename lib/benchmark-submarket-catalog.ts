...
export const CURATED_BENCHMARK_SUBMARKET_SEEDS: readonly CuratedBenchmarkSubmarketSeed[] = [
  ...
  submarketSeed({
    id: "submarket-boston-back-bay",
    marketId: "market-boston",
    label: "Back Bay",
    geocodeQuery: "Back Bay, Boston, MA",
    aliases: ["back bay boston"],
  }),
  submarketSeed({
    id: "submarket-boston-financial-district",
    marketId: "market-boston",
    label: "Financial District",
    geocodeQuery: "Financial District, Boston, MA",
    aliases: ["downtown boston"],
  }),
  submarketSeed({
    id: "submarket-boston-cambridge-kendall-square",
    marketId: "market-boston",
    label: "Cambridge / Kendall Square",
    geocodeQuery: "Kendall Square, Cambridge, MA",
    aliases: ["kendall square", "cambridge"],
  }),
  submarketSeed({
    id: "submarket-atlanta-midtown",
    marketId: "market-atlanta",
    label: "Midtown Atlanta",
    geocodeQuery: "Midtown Atlanta, Atlanta, GA",
  }),
  submarketSeed({
    id: "submarket-dallas-downtown-uptown",
    marketId: "market-dallas",
    label: "Downtown / Uptown Dallas",
    geocodeQuery: "Downtown Dallas, Dallas, TX",
    aliases: ["uptown dallas"],
  }),
  submarketSeed({
    id: "submarket-austin-downtown",
    marketId: "market-austin",
    label: "Downtown Austin",
    geocodeQuery: "Downtown Austin, Austin, TX",
  }),
  submarketSeed({
    id: "submarket-denver-downtown",
    marketId: "market-denver",
    label: "Downtown Denver",
    geocodeQuery: "Downtown Denver, Denver, CO",
  }),
  submarketSeed({
    id: "submarket-nashville-downtown",
    marketId: "market-nashville",
    label: "Downtown Nashville",
    geocodeQuery: "Downtown Nashville, Nashville, TN",
  }),
  submarketSeed({
    id: "submarket-san-francisco-mission-bay-soma",
    marketId: "market-san-francisco",
    label: "Mission Bay / SoMa",
    geocodeQuery: "Mission Bay, San Francisco, CA",
